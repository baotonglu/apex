...
namespace alex {
double debug_vlaue = -492.09272734917431080248206853866577148;
double debug_max_vlaue = -492.0772562400622973655117676;
double precise_value = 0.0000000000000001;
